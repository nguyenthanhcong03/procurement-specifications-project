...
import {getProgramByProcessVersionName} from "../../services/graphService.js";
...
const VersionFilter = () => {
    const {
        search,
        processName,
        getVersionPageByProcess
    } = useStore().versionStore;

    const handleSubmit = (value) => {
        getVersionPageByProcess(value,processName)
    };
...
export default observer(VersionFilter);